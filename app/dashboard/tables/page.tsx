...
export default function TablesPage() {
  ...
  const handleCreateTable = async () => {
    ...
    try {
      const tableId = await createTable(tableNumber, qrUrl)
      // Update dengan QR URL setelah create
      await updateTable(tableId, { qrUrl })
    } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <TableQRCard
              ...
              qrUrl={selectedTable.qrUrl || getQRUrl(selectedTable.number)}
            />
          </div>
        </div>
      )}
          ...
          >
            ...
            <div className="mb-4">
              <TableQRCard
                ...
                qrUrl={table.qrUrl || getQRUrl(table.number)}
              />
            </div>
